...
class TimeslotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timeslot" do
    assert_difference('Timeslot.count') do
      post timeslots_url, params: { timeslot: { end_time: @timeslot.end_time, start_time: @timeslot.start_time } }
    end
  ...
  test "should update timeslot" do
    patch timeslot_url(@timeslot), params: { timeslot: { end_time: @timeslot.end_time, start_time: @timeslot.start_time } }
